                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="dashboard-box margin-top-0">
                                ...
                                <!-- Headline -->
                                <div class="headline">
                                    <h3><i class="icon-material-outline-account-circle"></i> Verified Users</h3>
                                </div>
      ...
      <table id="example" class="table table-hover responsive nowrap" style="width:100%">
        ...
        <tbody>
          @foreach ($users as $user)
            ...
            <td>
              <a href="#">
                <div class="d-flex align-items-center">
                  <div class="avatar avatar-blue mr-3"><span class="innner">{{strtoupper(@$user->name[0])}}</span></div>
            ...
            <td>{{$user->email}}</td>
            <td>{{$user->user_type==\App\User::USER_FREELANCER?'Freelancer':'User'}}</td>
            <td>
              <div class="dropdown">
