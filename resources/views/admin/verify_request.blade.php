                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="dashboard-box margin-top-0">
                                ...
                                <!-- Headline -->
                                <div class="headline">
                                    <h3><i class="icon-material-outline-account-circle"></i> Verify Request</h3>
                                </div>
      ...
      <table id="example" class="table table-hover responsive nowrap" style="width:100%">
        ...
        <tbody>
          @foreach ($requests as $request)
            ...
            <td>
              <a href="#">
                <div class="d-flex align-items-center">
                  ...
                  <div class="">
                    <p class="font-weight-bold mb-0">{{$request->name}}</p>
            ...
            <td>{{$request->user->user_type==1?'User':'Freelancer'}}</td>
            <td>{{$request->verification_status}}</td>
            <td><a href="{{route('view.verify.profile.admin',['profile'=>$request->id])}}" class="button ripple-effect button-sliding-icon coolor">Verify <i class="icon-feather-arrow-right"></i></a></td>
          </tr>
          @endforeach
          ...
          {{-- <tr>
            ...
            <td>Freelancer</td>
           <td><a href="{{url('/admin/verify_profile')}}" class="button ripple-effect button-sliding-icon coolor">Verify <i class="icon-feather-arrow-right"></i></a></td>
          </tr>
                    <tr>
            <td>
              <a href="#">
            ...
            <td>admin@admin.com</td>
            <td>Freelancer</td>
            <td><a href="dashboard-verify-submit.html" class="button ripple-effect button-sliding-icon coolor">Verify <i class="icon-feather-arrow-right"></i></a></td>
          </tr>
          <tr>
            <td>
              <a href="#">
